...
namespace FinancasApp.Presentation.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        /// <summary>
        /// Método para receber uma requisição JS assíncrona (AJAX)
        /// </summary>
        public JsonResult PesquisarContas(DateTime dataMin, DateTime dataMax)
        {
            try
            {
                //capturando o usuário autenticado no projeto
                ...
                graficoDonut.Add(new ChartViewModel
                {
                    ...
                    Data = contas.Where(c => c.Tipo == Domain.Enums.TipoConta.Receber).Sum(c => c.Valor)
                });
                graficoDonut.Add(new ChartViewModel
                {
